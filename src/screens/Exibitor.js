    ...
    return (
        <View style={styles.container}>
           ...
           <Left style={{marginTop:hp(1),marginLeft:hp(1)}} name='arrowleft' size={25} color="#5669FF"/>
             <Text style={{fontSize:hp(3),marginLeft:hp(2),marginTop:hp(1),color:"#1C2833"}}>Exibitors</Text>
           </View>
           </TouchableOpacity>
        ...
        <View style={{backgroundColor:"#fff",width:wp(95),height:hp(6),borderRadius:50,borderColor:"gray",borderWidth:1,flexDirection:'row',marginLeft:hp(1),paddingHorizontal:hp(0)}}>
                <View style={{width:wp(85)}}>
                    <TextInput
                        ...
                        style={{ backgroundColor:"#fff",borderRadius: 100, color: '#1C2833', paddingHorizontal: 10, paddingVertical: 15, width: wp(80), marginVertical: 10, borderColor: "#EBEEF2",color:'#1C2833' }}
                ...
                <Search style={{marginRight:hp(2)}} name='search1' size={25} color="gray"/>
                </View>
                <View>
